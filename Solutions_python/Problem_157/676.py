...
# quaternions as: 1,i,j,k,-1,-i,-j,-k
qnions = ['1', 'i', 'j', 'k', '-1', '-i', '-j', '-k']
postmulti = [1, 4, 7, 2, 5, 0, 3, 6]
postmultj = [2, 3, 4, 5, 6, 7, 0, 1]
postmultk = [3, 6, 1, 4, 7, 2, 5, 0]
mult = [None, postmulti, postmultj, postmultk]
