...
int main()
{
    ...
    for (int pp = 1; pp <= np; pp++)
    {
        ...
        // then in a loop, walk until the end of the string
        // if you see a negative, keep counting until you see a positive, once you do, do flips + 2
        // if the array ends in a -, do flips + 2
        while (index < (int)pan.size())
        {
            if (pan[index] != last)
            {
                if (last == '-')
