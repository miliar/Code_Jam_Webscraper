    ...
    int solve( char ch[200] ){
        ...
        while(true){
                ...
                if( ch[ i ] == '+' ){
                    ...
                    F( element , 0 , (length - noofplus + 1)/2 ){
                       
                        char secondelement = ( ch[ length - noofplus - 1 - element ] == '+' )?'-':'+' ;
                        ch[ length - noofplus - 1 - element ] =  ( ch[ element ] == '+' )?'-':'+' ;
                        ch[ element ] = secondelement ; 
                        //cout<<" at "<<element<<" is "<<ch[element]<<endl ; 
