...
int main()
{
    ...
    for (int caseId=1; caseId<=caseNum; caseId++)
    {
        ...
        cout << "Case #" << caseId << ": " << result[ret] << endl;
    }
    return 0;
}
