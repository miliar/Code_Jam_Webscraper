...
int main()
{
	...
	//freopen("..\\B-small-attempt2.in","r",stdin);freopen("..\\B-small.out","w",stdout);
	//freopen("..\\B-small-attempt3.in","r",stdin);freopen("..\\B-small.out","w",stdout);
