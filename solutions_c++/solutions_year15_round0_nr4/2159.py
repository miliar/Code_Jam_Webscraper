...
string solution(int X,int R,int C){
	string winner ="RICHARD",winner2 = "GABRIEL";
	int cells= R*C;
	if (X == 1){ return winner2; }
	else if (X > R*C){ return winner; }
	else if (X==2){ 
		if ((R*C % 2) == 0){ return winner2; }
		else { return winner; }
	}
	else if (X == 3){
		if (cells == 6 || cells == 9 || cells == 12){ return winner2; }
		else { return winner; }
	}
	else {
		if (cells == 12 || cells == 16){ return winner2; }
		else { return winner; }
	}
	return winner;
}
