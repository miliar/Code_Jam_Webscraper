...
int main()
{
    ...
    REP(a,T)
    {
        ...
        if( ( (c*r) % x) != 0 ) printf("Case #%d: RICHARD\n",a+1);
        else if(x == 1) printf("Case #%d: GABRIEL\n",a+1);
        else if(x == 2) printf("Case #%d: GABRIEL\n",a+1);
        else if(x == 4)
        {
            if(r == 3 && c == 4)  printf("Case #%d: GABRIEL\n",a+1);
            else if(r == 4 && c == 3 ) printf("Case #%d: GABRIEL\n",a+1);
        ...
        else if(x == 3)
        {
            ...
            else if (r == 2 ||  r == 4) printf("Case #%d: GABRIEL\n",a+1);
