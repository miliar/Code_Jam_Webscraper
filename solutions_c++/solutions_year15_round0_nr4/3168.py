...
int main(){
    freopen("D-small-attempt8 (1).in","r",stdin);
...
//        cout << t << " " << x << " " << r << " " << c << endl;
        ...
        if (x == 2){
            if (r%2 + c%2 != 2)     P("Case #%d: GABRIEL\n",++cs);
            else                    P("Case #%d: RICHARD\n",++cs);
        }

        if (x ==3){
            if (r == 2 && c == 3)   P("Case #%d: GABRIEL\n",++cs);
            else if (r==3 && c==4)  P("Case #%d: GABRIEL\n",++cs);
            else if (r==3 && c==3)  P("Case #%d: GABRIEL\n",++cs);
            else                    P("Case #%d: RICHARD\n",++cs);

        }

        if (x == 4){
            if (r == 3 && c == 4)   P("Case #%d: GABRIEL\n",++cs);
            else if (r == 4 && c == 4)   P("Case #%d: GABRIEL\n",++cs);
            else P("Case #%d: RICHARD\n",++cs);
        }
    }
return 0;
