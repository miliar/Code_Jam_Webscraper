...
int main()
{
 ...
 char *p, a[150][150][101], b[150][150][101], temp[200];
 cin >> test;
 testnum = test;
 while (test--)
	{cin >> ep>> mp;
	...
	for(i=0; i<ep; i++)	
		{temp1 = 0;
		 ...
		 while(!(strcmp(a[i][temp1], b[j][temp1])))
			{temp1++;
	...
	temp1=0;
	//cout << strcmp(b[j][temp1], "0ing") << "hell";
	while((strcmp(b[j][temp1], "0ing")!=0))
		{//cout << b[j][temp1] <<temp1<< endl;
		 strcpy(a[ep][temp1],b[j][temp1]);
		 temp1++;
