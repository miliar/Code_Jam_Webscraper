...
i64 isPrime2( i64 n , i64 base ) {
        i64 rem = BigMod( base, MostSigBit, 2LL );
        if( ( rem + n ) % 2 == 0 ) return 2;

        for( i64 i = 3, sq = sqrt( n ); i <= sq; i++ ) {
                i64 rem = BigMod( base, MostSigBit, i );
                if( ( rem + n ) % i == 0 ) {
                        return i;
                }
        }
        ...
        readcase {
                ...
                while( s < t ) {
                        ...
                        for( i = 2; i <= 10 ; i++ ) {
                                ...
                                i64 pr;
                                if( MostSigBit == 0 ) pr = isPrime( v );
                                else pr = isPrime2( v, i );
