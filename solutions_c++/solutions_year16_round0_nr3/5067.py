#include<bits/stdc++.h>
using namespace std;
inline long long MultiplyMod(long long a, long long b, long long mod) {
...
inline long long PowerMod(long long a, long long n, long long mod) {
    long long r = 1LL;
    while (n) {
...
inline long long pt(long long b, long long e){
     if(e == 0LL)return 1LL;
     if(e == 1LL)return b;
     long long ans = pt(b,e>>1LL);
     return ans*ans*pt(b,e&1LL);
}
inline string convert(int n, long long R){
  string ans = "";
  for(int i = 0; i < n; i++){
       if(R&(1LL<<i)){
           ans = "1"+ans;
