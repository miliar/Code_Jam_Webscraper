...
//#define INPUT freopen("B-small-attempt4.in", "rt", stdin);
//#define INPUT freopen("B-small-attempt3.in", "rt", stdin);
//#define INPUT freopen("B-small-attempt2.in", "rt", stdin);
//#define INPUT freopen("B-small-attempt1.in", "rt", stdin);
//#define INPUT freopen("B-small-attempt0.in", "rt", stdin);
#define INPUT freopen("B-large.in", "rt", stdin);
