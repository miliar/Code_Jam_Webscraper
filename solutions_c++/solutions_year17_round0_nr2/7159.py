...
int main() {
//    assert(freopen("/Users/kaidul/Documents/C++ workspace/Test/Test/B-large.in", "r", stdin));
//    assert(freopen("/Users/kaidul/Documents/C++ workspace/Test/Test/output.txt", "w", stdout));
    int tcase;
    SDi(tcase);
    int caseNo = 0;
    i64 n;
    while(tcase--) {
        ...
        if(i == m - 1) {
            ...
            result += (sN[i] - 1);
            int k = i;
            while(k > 0 and result[k - 1] > result[k]) {
                result[k - 1]--;
                result[k] = '9';
                k--;
            }
