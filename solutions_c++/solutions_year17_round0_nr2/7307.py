...
void Tidify(char* str)
{
	int i = 0;

	while (i = WhereNotTidy(str))
	{
...
void Tidy()
{
	...
	FILE* output = fopen("..\\Output\\tidy.out", "wt");
	...
	for(int i = 0; i < testcase; i++)
	{
		...
		uint64 ui64 = _strtoui64(arr, NULL, 10);

		
		fprintf(output, "Case #%d: %llu\r", i+1, ui64);
	}
