...
// void recur(int r, int c, int st, double res){
// 	//cout<<r<<" "<<c<<" "<<st<<" "<<res<<endl;
// 	if(st>s){
// 		if(mx<res)
// 			mx=res;
// 	//	cout<<"MAX: "<<mx<<endl;
...
// 	else{
// 		if(isSafe(r,c)==true){
// 			if(a[r][c]=='.' && !(r==m && c==n && st==0)){
// 				res+=pow(1.0-q,b[r][c])*q;
// 	//			cout<<"."<<endl;
// 			}
// 			else if(a[r][c]=='A' && !(r==m && c==n && st==0)){
// 				res+=pow(1.0-p,b[r][c])*p;
// 	//			cout<<" A"<<endl;
// 			}
// 			if(st!=0)
// 				b[r][c]++;
// 			recur(r+1,c,st+1,res);
// 			recur(r-1,c,st+1,res);
// 			recur(r,c+1,st+1,res);
// 			recur(r,c-1,st+1,res);
// 			if(st!=0)
// 				b[r][c]--;
// 			return;
