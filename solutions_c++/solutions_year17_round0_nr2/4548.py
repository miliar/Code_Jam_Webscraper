...
int main()
{
    ...
    // freopen("b_small_in.in","r",stdin);
    // freopen("b_small_out.out","w",stdout);

    freopen("b_large_in.in","r",stdin);
    ...
    while(test--)
    {
    	...
    	{
    		FOR(i,idx,s.size()-1) cout<<'9'; cout<<endl;
    	}
    	else
    	{
    		FOR(i,0,idx) cout<<s[i];
    		cout<<char(s[idx]-1);
    		FOR(i,idx+1,s.size()) cout<<'9';
    		cout<<endl;
    	}
    }
