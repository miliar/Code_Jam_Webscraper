...
#define open       freopen("B-large.txt","r",stdin)
...
#define prcs(y) printf("Case #%lld: ",y)
#define gc() getchar()
#define w(t) while(t--)
...
int main()
{
    ...
    ll t,i,j,q,k,n,l,r,st,ed,pos,val,p,x,y,n1,n2,c,sum,cnt,dif,idx,m;
