...
struct trip{int st,ed;}ta[110],tb[110];
int mark[110];

int cmp1(const void *a,const void *b){return ((trip*)a)->st - ((trip*)b)->st;}
int cmp2(const void *a,const void *b){return ((trip*)a)->ed - ((trip*)b)->ed;}
