...
//    sort(v.begin(), v.end());
//    for (int i = 0; i < m; i++){
//        int temp = v[i].first.second;
//        while (temp != v[i].first.first - 1 && set_c.find(v[i].second) != set_c.end()){
//            if (a[v[i].first.second] == 1e9 - 1){
//                a[v[i].first.second] = v[i].second;
//                set_c.erase(v[i].second);
//                break;
//            }
//            temp--;
//        }
...
//        for (int i = 0; i < 1e6; i++){
//            cin >> prime_num;
//            sprime.insert(prime_num);
//            if (i % 1000000 == 0) cout << j << "e6" << endl;
//            if (i % 100000==0){cout << "HELLO " <<i<< endl;}
//        }
//    }
//    freopen("input.txt", "r", stdin);
//    freopen("output.txt", "w", stdout);
//    ll t, n,j;
//    vector<string> vperm,vperm_base[51],vtemp;
//    string line="";
//    ll res = 0, ok, nok = 0, nans = 0;
//    cin >> t >> n >> j;
//
//    for (int i = 0; i < t; i++){
//        for (int mask = 0; mask < (1 << n) && nans < j; ++mask) {
//            vtemp.clear();
//            line = "";
//            for (int bit = 0; bit < n; ++bit)
//            if (mask & (1<< bit)) line+='1'; else line+= '0';
//            //cout << line << endl;
...
//                continue;
//            }
//            vperm.push_back(line);
//            for (int base = 2; base <= 10; base++){
//                res = 0;
//                for (int jind = line.length()-1,pos=0; jind >= 0; jind--,pos++)
//                    res += pow(base,pos) * (vperm[nans][jind]-'0');
//                if (sprime.find(res) == sprime.end() && res != 0){
//                    for (int i = 2; i < res; i++){
//                        if (res % i == 0)
//                        { 
//                            vtemp.push_back(to_string(res/i));
//                            break;
//                        }
//                    }
//                }
...
//                }
//                if (base == 10){
//                    vtemp.push_back(to_string(res));
//                }
//            }
//            if (ok){
//                //vtemp.push_back(line);
//                vperm_base[nans++] = vtemp;
//                //cout << res << endl;
//            }else{
//                vperm.pop_back();
//                ok = 1;
...
//TASK B GOOGLE CODE JAM 2016
//int a[101] = {0};
//int main(){
//    freopen("B-large.in", "r", stdin);
//    freopen("B-large.out", "w", stdout);
//    int t,nhappy=0,nblank=0,nflip=0;
//    cin >> t;
//    string stack;
//    for (int i = 0; i < t; i++){
//        cin >> stack;
...
//            }
//        }
//        cout << "Case #" << i+1 << ": " << nflip << endl;
//    }
//    return 0;
//}


//TASK A GOOGLE CODE JAM 2016
//int main(){
