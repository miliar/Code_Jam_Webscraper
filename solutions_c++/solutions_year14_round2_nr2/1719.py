...
int main() {
	...
	//freopen("C:\\Olimp2014\\JAM1_14_B\\input.txt","r",stdin);
	 freopen("B-small-attempt0.in","r",stdin);freopen("output-small-attempt.txt","w",stdout);//FILE * f, *g; f = fopen ("input.txt","r");//g = fopen ("output.txt","w");
