...
int main() {
    ...
    for (int t=1; t<=T; t++) {
        ...
        if (n == 2) {
            if (a[1].second <= 720 || a[0].first >= 720)
                ans = 2;
            else if (a[1].second - a[0].first <= 720)
                ans = 2;
            ...
            if (b[1].second <= 720 || b[0].first >= 720)
                ans = 2;
            else if (b[1].second - b[0].first <= 720)
                ans = 2;
        ...
        /*
        for (int i=0; i<n; i++)
            dump(a[i].first/60, a[i].first%60, a[i].second/60, a[i].second%60);

        for (int i=0; i<m; i++)
            dump(b[i].first/60, b[i].first%60, b[i].second/60, b[i].second%60);
*/
    }
