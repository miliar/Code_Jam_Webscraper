...
#define REE(s_) {cout<<s_<<'\n';continue;} //print s_ and terminate program
...
int main(){
    ...
    FORE(t,1,N){
        ...
        if((arr[0].e2 <= 720 && arr[1].e2 <= 720 )||(arr[0].e1 > 720 && arr[1].e1 > 720)){
            REE("2");
        }
        if(arr[1].e2 - arr[0].e1 > 720 && arr[0].e2 + (1440 - arr[1].e1) > 720){
            REE("4");
        }
        REE("2");
    }
