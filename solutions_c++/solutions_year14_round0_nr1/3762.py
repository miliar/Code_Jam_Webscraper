...
int main()
{
	...
	for (int testcase = 1; testcase <= t;testcase++)
	{
		...
		int count = 0; int ansindex;
		for (int i = 0; i < 16; i++) if (arr[i] == 2) {ansindex = i; count++;}
		
		if (count == 1) cout << "Case #" << testcase << ": " << ansindex+1<<endl;
		else if (count == 0) cout << "Case #" << testcase << ": Volunteer cheated!"<<endl;
