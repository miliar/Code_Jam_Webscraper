...
int main()
{
	ifstream cin("b.in");
	ofstream cout("b.out");
	int k=0,win,r1,r2,temp,t,tab1[4][4],tab2[4][4],rows[17];
	cin>>t;
	while(t--){
		k++;
		int c(0);
		...
		REP(i,4) if(rows[tab2[r2-1][i]]==r1)
			c++,win = tab2[r2-1][i];
		if(c==0) cout<<"Case #"<<k<<": "<<"Volunteer cheated!"<<endl;
		else if(c==1) cout<<"Case #"<<k<<": "<<win<<endl;
