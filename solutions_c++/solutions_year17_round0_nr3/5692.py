...
int main(int argc, const char * argv[]) {
    freopen("/Users/shashanksaurabh/Desktop/Journey/j-3/j-3/C-small-1-attempt0.in", "r",stdin);
    freopen("/Users/shashanksaurabh/Desktop/Journey/j-3/j-3/ansSmall2.txt","w",stdout);
