...
void solve(istream &cin, ostream &cout, int test_number = -1) {
    ...
    set<pair<ll, ll>, greater<pair<ll, ll>>> s;  // number and amount of numbers
    s.insert({n, 1});
    ...
    cout << "Case #" << test_number << ": " << a << ' ' << b << endl;
}
