...
define_pair(node, l, r)

bool operator <(ConstRef<node> n1, ConstRef<node> n2)
{
    return n1.r - n1.l != n2.r - n2.l ? n1.r - n1.l > n2.r - n2.l : n1.l < n2.l;
}

int main(int, char *[])
{
    freopen("C:/Users/Infinity/Downloads/C-small-2-attempt1.in", "r", stdin);
    freopen("C:/Users/Infinity/Downloads/C-small-2-attempt1.out", "w", stdout);
    for (int tt = getint(), ti = 1; ti <= tt; ++ti) {
