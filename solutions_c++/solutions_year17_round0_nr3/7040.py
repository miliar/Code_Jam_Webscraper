...
#define OUT_FILE "C-small-1-attempt0.out"
#define N 1000
#elif FILE == SMALL_2
#define IN_FILE "C-small-2-attempt0.in"
#define OUT_FILE "C-small-2-attempt0.out"
#define N pow(10, 6)
#elif FILE == LARGE
...
inline void solve2(unsigned long long n, unsigned long long k, unsigned long long * nr, unsigned long long * kr)
{
