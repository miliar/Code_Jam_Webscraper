...
string bs[3][13]; //Best string leading to a victory by i (0=Rock, 1=Paper, 2=Scissors) in n rounds
void init() {
	bs[0][0] = "R";
	bs[1][0] = "P";
	bs[2][0] = "S";
	...
	for (int n=1; n<=12; n++) {
		for (int i=0; i<3; i++) {
			string sub1 = bs[i][n-1];
			string sub2 = bs[(i+2)%3][n-1];
