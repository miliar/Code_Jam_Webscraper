//// Round1CQ1.cpp : Defines the entry point for the console application.
//
...
{
public:
	RES(const long long a, const long long b):i(a),j(b){};
	long long i,j;
}*/
...
int main(int argc, char *argv[])
{
	...
	int T,Case=0; 
	char a[101];
    long long N,len, res, j, i, k, cons;
	//	vector <RES> vec;
//	RES temp;
    ...
    do
    {
	   ...
	   len = strlen(a);
	   res =0;
	   for(i=0, j=0, cons=0, k=0;i<len;++i)
	   { 
...
//}
//int main() {
//	freopen("F:\\Projects And Programs\\C++\\Google CodeJam 2013\\Data\\Round1BQ1In.txt", "r", stdin);
//	freopen("F:\\Projects And Programs\\C++\\Google CodeJam 2013\\Data\\Round1BQ1Out_Correct.txt", "w", stdout);
//
//	char tmp[333];
//	int kolt = 0;
//	gets(tmp);
