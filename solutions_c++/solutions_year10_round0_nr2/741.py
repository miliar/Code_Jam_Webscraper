...
int SolveIt()
{
	...
	for (int i=0;i<N;i++)
	{
		string sst = toString((strNum[i]));
		num.push_back(toInt64(sst));
	}
...
int main()
{
	...
	freopen("..\\B-small-attempt5.in","r",stdin);freopen("..\\B-small.out","w",stdout);
