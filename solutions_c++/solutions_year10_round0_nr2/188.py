...
int main() {
    int C, N;
		BigUnsigned t[maxN];
		BigUnsigned mint, gcdall, remaining;
		string st;
      ...
      gcdall = gcd(t[0] - mint, t[1] - mint);
      for(int i=2; i<N; i++) {
        gcdall = gcd(gcdall, t[i] - mint);
      }
      
      remaining = mint % gcdall;
      if(remaining != 0) {
        remaining = gcdall - remaining;
      }
      
      cout << "Case #" << c << ": " << remaining << endl;
    }
