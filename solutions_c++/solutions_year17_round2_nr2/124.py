...
struct solution {
    ...
    void solve() {
        ...
        sort(all(t), [&](const vector <string> &a, const vector <string> &b) {
        ...
        forn(i, t[1].size()) {
            e.insert(e.begin() + 2 * i, t[1][i]);
        }

        forn(i, t[2].size()) {
            e.insert(e.end() - 1 - 2 * i, t[2][i]);
        }

        ans = accumulate(all(e), string());
    }
