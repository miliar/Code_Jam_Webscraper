...
string ringit(int tre, string db, string one) {
	string ring = "";
	for (int i = 0; i < tre; ++i) ring += db;
	ring += one;
	return ring;
}
struct Col {
...
char getmaxdec(vector<Col>& cols, char ntu) {
