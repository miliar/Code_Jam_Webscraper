...
void solve(istream &cin, ostream &cout, int test_number = -1) {
    ...
    if (!o && !g && !v) {
        ...
        if (ans.back() == a[2].second) {
            swap(a[1], a[2]);
        }
        for (int i = 0; a[2].first && a[1].first; ++i) {
//            int j = ((i + 1) & 1) + 1;
//            int k = 3 - j;
...
//        }
        ...
        cout << (check(ans) ? ans : "IMPOSSIBLE") << endl;
        return;
    }
    cout << "IMPOSSIBLE\n";
}
