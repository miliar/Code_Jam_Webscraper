...
ll binpowmod(ll a, ll b, ll mod){ll res = 1;while(b){if(b & 1){res *= a;res %= mod;b--;}else{a *= a;a %= mod;b >>= 1;}}return res;}
ll binpow(ll a, ll b){ll res = 1;while(b){if(b & 1){res *= a;b--;}else{a *= a;b >>= 1;}}return res;}
