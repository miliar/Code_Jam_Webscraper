...
freopen("out.txt","w",stdout);
    ...
    for(int k=1;k<=tt;k++)
    {
        ...
        while(true)
        {
            ...
            if(ara[0].F==0)
                break;
            if(ara[0].F==1&&ara[1].F==1&&ara[2].F==1)
            {
                cout<<' '<<(char)(ara[0].S+65)<<' '<<(char)(ara[1].S+65)<<(char)(ara[2].S+65);
                ara[0].F--;
                ara[1].F--;
                ara[2].F--;
            }
            else if(ara[0].F>ara[1].F)
            {

                cout<<' '<<(char)(ara[0].S+65);
                ara[0].F--;

            }
            else if(ara[0].F==ara[1].F)
            {
                cout<<' '<<(char)(ara[0].S+65)<<(char)(ara[1].S+65);
                ara[0].F-=1;
                ara[1].F-=1;
            }
        }
