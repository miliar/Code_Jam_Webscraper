...
int32_t main(){
	...
	rep(z,1,t+1){
		...
		rep(i,0,n){
			int x,y; cin>>x>>y;
			long double temp=(long double)(d-x)/(long double)y;
			if(temp-t>1e-10) t=temp;
		}
		long double ans=(long double)d/(long double)t;
		cout<<fixed<<"Case #"<<z<<": "<<setprecision(11)<<ans<<endl;
	}
}
