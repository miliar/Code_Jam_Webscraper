...
void isGold(){
    ifstream fin;
    ofstream fout;
    fin.open("/Users/christiana/Documents/workspace/leetcode/codejam/codejam/D-small-attempt2.in");
    fout.open("/Users/christiana/Documents/workspace/leetcode/codejam/codejam/output(2).txt");
    int n;
    fin >> n;
    for(int i = 0; i < n; ++i){
        int k, c, s;
        ...
        if(s < k/c){
            ...
            else{for(int j = 0; j < newkc; ++j){//第j个输出
                //cout << "j" << j << endl;
                int i1 = j * int(k/c) + 1;
                num = j * int(k/c) + 1;
                for(int l = 1; l < c; ++l){
