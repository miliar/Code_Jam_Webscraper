...
#define INF 100000000000000000LL    //just infinity
...
int minProduct(VI &X, VI& Y)
{
	...
	REP(i, X.size())
	{
		REP(j, Y.size())
		{
			cost[i][j] =  INF - X[i]*Y[j];
		}
	}

	int ret = 0;                      //weight of the optimal matching
	max_match = 0;
	n = X.size();				//number of vertices in current matching
