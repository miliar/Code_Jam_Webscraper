...
// C(i): expected number of steps to correcly arrange a permutation cycle of length i.
// A given random permutation of size 'n' has on average '1.0/m' cycles of length 'm'.
// C(1) = 0
// C(2) = 1 + 1/1 * C(1) + 1/2 * C(2)  =>  0.5 C(2) = 1  =>  C(2) = 2
// C(3) = 1 + 1/1 * C(1) + 1/2 * C(2) + 1/3 * C(3)  =>  C(3) = 3
// C(i) = 1 + 1/1 * C(1) + ... + 1/i * c(i)  =>  C(i) = i
// To sort a cycle of length m, on average m GoroSort steps are needed.
// Total size of cycles = Number of incorrecly placed elements.
