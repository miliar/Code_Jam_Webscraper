...
#define printf(x, y...) { printf(x, ##y); fflush(stdout); }
#define output_case(x, y...) { case_num++; printf("Case #%d: "x, case_num, ##y); }
#ifdef DEBUG
...
void read_line(string& x)
{
	...
	if (n == 8191 || n == 0) {
		fprintf(stderr, "ERROR: No newline found, %d extracted.\n", (int)n);
		exit(1);
	}
	x.append(buf, n);
}
