...
int main()
{
    int i,j,Case=1,test,N;
    int B_pos,O_pos,B_time,O_time,curr_time,dis,dis_time,button;
    char ch[3];
    ...
    while(test--)
    {
        ...
        for(i=0;i<N;i++)
        {
            ...
            if(ch[0]=='O')
            {
                dis=abs(button-O_pos);
                dis_time=curr_time-O_time;
                dis-=dis_time;
                if(dis<0) dis=0;
                curr_time+=dis+1;
                O_pos=button;
            ...
            {
                dis=abs(button-B_pos);
                dis_time=curr_time-B_time;
                dis-=dis_time;
                if(dis<0) dis=0;
                curr_time+=dis+1;
                B_pos=button;
