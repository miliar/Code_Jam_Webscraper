...
int main(void) {
	...
	REP(__number_of_case, __number_of_cases) {
		...
		cin >> steps;
		//cout << steps << '\n';
		int blue_pos(1), blue_time(0), orange_pos(1), orange_time(0);
		int time(0);
		REP(i, steps) {
			char c;
			int pos;
			...
			//cout << "Time: " << time << ", blue: (" << blue_pos << ", " << blue_time << "); orange: (" << orange_pos << ", " << orange_time << ")\n";
		}
		cout << "Case #" << __number_of_case+1 << ": " << time << '\n';
	}
}
