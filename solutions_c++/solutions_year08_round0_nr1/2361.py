...
int add_string(hash_table_t *hashtable, char *str,int pos)
{
    list_t *new_list;
    list_t *current_list;
    unsigned int hashval = hash(hashtable, str);
//	cout<<"pos2:"<<pos<<endl;
    ...
    if ((new_list = (list_t *)malloc(sizeof(list_t))) == NULL) return 1;
...
//	cout<<"pos-1:"<<pos<<endl;
   ...
   // {
    //    return 2;
       // if(current_list->count==1)current_list->no=pos;
   // }
    /* Insert into list */
