...
long long table[MAXL]={1LL,4LL,9LL,121LL,484LL,10201LL,12321LL,14641LL,40804LL,
44944LL,1002001LL,1234321LL,4008004LL,100020001LL,102030201LL,104060401LL,
...
int main()
{
    ...
    {
        scanf("%I64d %I64d",&a,&b);
        printf("Case #%d: %d\n",c+1,upper_bound(table,table+MAXL,b)-lower_bound(table,table+MAXL,a));
    }
    return 0;
}
