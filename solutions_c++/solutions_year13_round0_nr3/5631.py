...
int main()
{
	freopen("C:/Users/zyren/Downloads/C-small-attempt0.in", "r", stdin);
	freopen("C:/Users/zyren/Downloads/C-small-attempt0.in.out", "w", stdout);
	int T,i=0,tag=0;
	long long int A,B,s,e,n;
	scanf("%d", &T);
	while (++i<=T)
	{
		n = 0;
		...
		while (s <= e)
		{
			if(palindromes(s)&&palindromes(s*s))
				n++;
			s++;
		}
		printf("Case #%d: %lld\n", i, n);
