...
int main()
{
	freopen("C-large-1.in","r",stdin); freopen("output.txt","w",stdout);
	int i,n,j,kol=0;
	long long int a,b;
	long long int mass[39]={1, 4, 9, 121, 484, 10201, 12321, 14641, 40804, 44944, 1002001, 1234321, 4008004, 100020001, 
	...
	for (j=1; j<=n; j++)
	{
		...
		cin>>a>>b; 
		for (i=0; i<39; i++)
			if (mass[i]>=a && mass[i]<=b) kol++;
		cout<<"Case #"<<j<<": "<<kol<<endl;
	}
	return 0;
}