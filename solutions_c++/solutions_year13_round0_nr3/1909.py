...
long long int nums[] = {1, 4, 9, 121, 484, 10201, 12321, 14641, 40804, 44944, 1002001, 1234321, 4008004, 100020001, 102030201,
...
int main(){
	...
	int t; scanf("%d", &t); while (t--){
		scanf("%lld %lld", &a, &b);
		int ido, idf; ido=idf=0;
		while (nums[ido] < a) ido++;
		while (nums[idf] <= b) { idf++; }
		printf("Case #%d: %d\n", ++exec, (idf-ido));
	}
	return 0;
}