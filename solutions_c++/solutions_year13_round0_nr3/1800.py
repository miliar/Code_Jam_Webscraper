...
#include<algorithm>
using namespace std;
long long t,a,b,ans,c;
long long store[100]={1LL,4LL,9LL,121LL,484LL,10201LL,12321LL,14641LL,40804LL,44944LL,1002001LL,1234321LL,
...
int main()
{
    ...
    while(t--)
    {
        ++c;
        scanf("%lld %lld",&a,&b);
        ans=upper_bound(store,store+39,b)-upper_bound(store,store+39,a-1);
        printf("Case #%lld: %lld\n",c,ans);
    }
    return 0;
}
