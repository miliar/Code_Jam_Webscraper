...
int main() {
    ...
    for( int TC=1; TC<=ntc; TC++ ) {
        LL A, B;
        scanf("%I64d %I64d", &A, &B);
        int nA = lower_bound( PSP, PSP + nPSP, A ) - PSP;
        int nB = upper_bound( PSP, PSP + nPSP, B ) - PSP;
        printf("Case #%d: %d\n", TC, nB-nA);
    }
