...
int main()
{
	...
	for ( i=1; i<=tee; i++, t-- )
	{
		switch ( sol[t] )
		{
			case 0	:	out<<"Case #"<<i<<": X won"<<endl; break;
			case 1	:	out<<"Case #"<<i<<": O won"<<endl; break;
			case 2	:	out<<"Case #"<<i<<": Draw"<<endl; break;
			case 3	:	out<<"Case #"<<i<<": Game has not completed"<<endl; break;
		}
	}
