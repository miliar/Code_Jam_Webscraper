...
ll A,B;
ll arr[]={ 1, 4, 9, 121, 484, 10201, 12321, 14641, 40804, 44944, 1002001, 1234321, 4008004, 100020001,
...
int main()
{
    ...
    {
        scanf("%lld %lld",&A,&B);
        int ans=((upper_bound(all(v),B)-v.begin()) - (lower_bound(all(v),A)-v.begin()));
        printf("Case #%d: %d\n",++cas,ans);
    }
    return 0;
}
