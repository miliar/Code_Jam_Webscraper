...
//{y, h, e, s, o, c, v, x, d, u, i, g, l, b, k, r, X, t, n, w, j, p, f, m, a, X};

int main()
{
//vector<char> tr = {'y', 'h', 'e', 's', 'o', 'c', 'v', 'x', 'd', 'u', 'i', 'g', 'l', 'b', 'k', 'r', 'q', 't', 'n', 'w', 'j', 'p', 'f', 'm', 'a', 'z'};
  vector<char> tr = {'y', 'h', 'e', 's', 'o', 'c', 'v', 'x', 'd', 'u', 'i', 'g', 'l', 'b', 'k', 'r', 'z', 't', 'n', 'w', 'j', 'p', 'f', 'm', 'a', 'q'};
//vector<char> tr = {'y', 'h', 'e', 's', 'o', 'c', 'v', 'x', 'd', 'u', 'i', 'g', 'l', 'b', 'k', 'r', 'X', 't', 'n', 'w', 'j', 'p', 'f', 'm', 'a', 'X'};
  ...
  while (T < 3) {
    ...
    for (uint i = 0; i < out.size(); ++i) {
      assert (i < input[T].size());
      //assert (input[T][i]-'a' < tr.size());
      if (out[i] != ' ' && !tr[input[T][i]-'a']) {
        tr[input[T][i]-'a'] = out[i];
      }
      //else
      //  assert ( tr[input[T][i]-'a'] == out[i] );
    }
