...
int main(){
	// preperation
	string english  = "a zoo|our language is impossible to understand|there are twenty six factorial possibilities|so it is okay if you want to just give up|q";
	string googlish = "y qee|ejp mysljylc kd kxveddknmc re jsicpdrysi|rbcpc ypc rtcsra dkh wyfrepkym veddknkmkrkcd|de kr kd eoya kw aej tysr re ujdr lkgc jv|z";
	VC gtoe(400);
	foru(i, sz(english)){
		gtoe[googlish[i]] = english[i];
	}
