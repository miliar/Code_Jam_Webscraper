...
{
	freopen("C:/Users/wangxun/Desktop/google code jam/A-small-attempt0.in", "r", stdin);
    freopen("C:/Users/wangxun/Desktop/google code jam/A-small-attempt0.out", "w", stdout);
	char board[4][4];
	int caseNo;
	int flag=1,spe=0;
	string s1 = "X won";
