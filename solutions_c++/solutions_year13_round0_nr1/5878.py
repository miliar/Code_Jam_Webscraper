        ...
        for(n=0;n<t;)
        {
                ...
                for(k=0;k<4;k++)
                {
                        if(arr[k][0]!='.')
                        {
                                ...
                                if((arr[k][0]=='O'||arr[k][0]=='T') && (arr[k][1]=='O'||arr[k][1]=='T') && (arr[k][2]=='O'||arr[k][2]=='T') && (arr[k][3]=='O'||arr[k][3]=='T'))
                                {
                                        printf("Case #%d: O won\n",n);
                                        flag=1;
                                        break;
                ...
                //cout<<"came out of for and flag is"<<flag<<endl;
