...
char grid[4][4];
char check(int si,int sj,int di,int dj)
{
	if(si+3*di<0||si+3*di>=4)
	{
		return '.';
	}
	if(sj+3*dj<0||sj+3*dj>=4)
	{
		return '.';
	}
	char t=grid[si][sj];
