...
bool check_vert(char (&board)[SIZE][SIZE], char T){
...
bool solve(char (&board)[SIZE][SIZE], char T){
	...
	return check_diag(board, T) || check_horiz(board, T) || check_vert(board, T);
}
