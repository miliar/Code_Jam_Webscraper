...
int main()
{
    ...
    while(tcase--)
    {
        ...
        bool is_finish=0, is_col_x=0, is_row_x=0, is_dia_x1=0, is_dia_x2=0, is_col_o=0, is_row_o=0, is_dia_o1=0, is_dia_o2=0, is_com=1;
        bool is_t=0;
        ...
        REP(i, 4)
        {
            ...
            REP(k, 4)
            {
                ...
                if(cnt==4 || (is_t==1 && cnt==3))  {is_col_x=1;}
            }
            if(is_col_x==1)   break;
        }
        //O
        REP(i, 4)
        {
            ...
            REP(k, 4)
            {
                ...
                if(cnt==4 || (is_t==1 && cnt==3)) is_col_o=1;
            }
            if(is_col_o==1)   break;
        }
        ...
        REP(i, 4)
        {
            ...
            REP(k, 4)
            {
                ...
                if(cnt==4 || (is_t==1 && cnt==3)) is_row_x=1;
            }
            if(is_row_x==1)   break;
        }
        cnt=0;
        ...
        REP(i, 4)
        {
            ...
            if(cnt_o==4 || (is_t==1 && cnt_o==3)) is_dia_o1=1;
            if(cnt_x==4 || (is_t==1 && cnt_x==3)) is_dia_x1=1;
        }

        cnt_o=0; cnt_x=0; is_t=0;
        for(i=3; i>=0; i--)
        {
            if(arr[i][3-i]=='T')  is_t=1;
            if(arr[i][3-i]=='X')  cnt_x++;
            if(arr[i][3-i]=='O')  cnt_o++;

            if(cnt_o==4 || (is_t==1 && cnt_o==3)) is_dia_o2=1;
            if(cnt_x==4 || (is_t==1 && cnt_x==3)) is_dia_x2=1;
        }


        if( ((is_row_x || is_col_x || is_dia_x1 || is_dia_x2) == (is_row_o || is_col_o || is_dia_o1 || is_dia_o2) ) && is_com==1)
        {
            csprint
            printf("Draw\n");
        }
        else if((is_row_x || is_col_x || is_dia_x1 || is_dia_x2))
        {
            csprint
            printf("X won\n");
        }
        else if((is_row_o || is_col_o || is_dia_o1 || is_dia_o2))
        {
            csprint
            printf("O won\n");
        }
     ...
     //   deb(is_row_o, is_col_o, is_dia_o1, is_dia_o2);
