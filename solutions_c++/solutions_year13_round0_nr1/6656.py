...
#include<stdio.h>
void tic(int );
int T,i,j,k,count[1000],flag,count1=0;;
char a[1000][4][4];
...
void tic(int flag)
{
    ...
    for(j=0;j<4;j++)
    {
		if((a[i][j][0]=='O'||a[i][j][0]=='T')&&(a[i][j][1]=='O'||a[i][j][1]=='T')&&(a[i][j][2]=='O'||a[i][j][2]=='T')&&(a[i][j][3]=='O'||a[i][j][3]=='T'))
		{
			cout<<"Case #"<<i+1<<": ";
			cout<<"O won\n";
			flag=1;
    ...
    for(k=0;k<4;k++)
	{
		if((a[i][0][k]=='O'||a[i][0][k]=='T')&&(a[i][1][k]=='O'||a[i][1][k]=='T')&&(a[i][2][k]=='O'||a[i][2][k]=='T')&&(a[i][3][k]=='O'||a[i][3][k]=='T'))
		{
			cout<<"Case #"<<i+1<<": ";
			cout<<"O won\n";
			flag=1;
