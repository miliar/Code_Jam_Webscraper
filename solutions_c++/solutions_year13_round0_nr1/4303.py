...
int main()
{
    ...
    for(int test = 1; test <= t; ++test)
    {
        ...
        forn(i, 4)
        {
            ...
            forn(j, 4)
            {
                if (s[i][j] == 'O' || s[i][j] == 'T') ++cnt1;
                if (s[i][j] == 'X' || s[i][j] == 'T') ++cnt2;
            }
            if (cnt1 == 4 && !fl)
            {
                fl = true;
        ...
        forn(i, 4)
        {
            ...
            forn(j, 4)
            {
                if (s[j][i] == 'O' || s[j][i] == 'T') ++cnt1;
                if (s[j][i] == 'X' || s[j][i] == 'T') ++cnt2;
            }
            if (cnt1 == 4 && !fl)
            {
                fl = true;
        ...
        forn(i, 4)
        {
            if (s[i][i] == 'O' || s[i][i] == 'T') ++cnt1;
            if (s[i][i] == 'X' || s[i][i] == 'T') ++cnt2;
        }
        if (cnt1 == 4 && !fl)
        {
            fl = true;
        ...
        forn(i, 4)
        {
            if (s[i][3 - i] == 'O' || s[i][3 - i] == 'T') ++cnt1;
            if (s[i][3 - i] == 'X' || s[i][3 - i] == 'T') ++cnt2;
        }
        if (cnt1 == 4 && !fl)
        {
            fl = true;
