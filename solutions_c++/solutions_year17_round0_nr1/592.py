...
void solve(int casenum, outboth rout) {
  ...
  if (std::count(All(B), true) == N) {
    rout << "Case #" << casenum << ": " << count << endl;
  } else {
    rout << "Case #" << casenum << ": IMPOSSIBLE" << endl;
  }
...
// clang-format off
// Local variables:
// compile-command: "c++ -fsanitize=address -std=c++11 -Wall -Wextra -g -o A A.cc && ./A A.test.in"
