...
int main()
{
    ...
    for (i = 0; i < t; i++) {
        ...
        for (j = 0; j < m; j++) {
            ...
            v.push_back(make_pair(b[i][0], make_pair(0, b[i][2])));
            v.push_back(make_pair(b[i][1], make_pair(1, b[i][2])));
                        
            x = n - (b[i][1] - b[i][0]);
            
            sum += (Int)((n * n + n - 2) / 2 - (x * x + x - 2) / 2) * b[i][2];
        }
        ...
        for (j = 0; j < v.size(); j++) {
            if (v[j].second.first == 0) {
                q.push(make_pair(v[j].first, v[j].second.second));
            } else {
                ...
                while (x) {
                    ...
                    if (p.second > x) {
                        long long y = n - (v[j].first - p.first);
                        
                        p.second -= x;
                        
                        q.push(p);
                        
                        sum -= (Int)((n * n + n - 2) / 2 - (y * y + y - 2) / 2) * x;
                        ...
                        sum -= (Int)((n * n + n - 2) / 2 - (y * y + y - 2) / 2) * p.second;
                    }
                }
            }
        }
        
        cout << "Case #" << i + 1 << ": " << sum % 1000002013 << endl;
    }
