...
{                                                               \
    ...
    auto f = [&](int x) -> mint {                               \
        ...
        return (2 * n - x - 1) * x / 2;                         \
                                                                ...
                                                                \
    mint res = 0;                                               \
    xfor(x, t, res += f(t.b - t.a) * t.c);                      \
    tup3c(E, int, cnt, int, pos, int, open, cmp_aa(pos, open)); \
    vector<E> e;                                                \
    xfor(x, t, e.push_back(E(t.c, t.a, 0)));                    \
    xfor(x, t, e.push_back(E(t.c, t.b, 1)));                    \
    _sort(e);                                                   \
    xfor(e, cur, {                                              \
        if (cur.open == 0)                                      \
        {                                                       \
            st.push(MP(cur.pos, cur.cnt));                      \
        }                                                       \
        else                                                    \
        {                                                       \
            int k = cur.cnt;                                    \
            ...
            {                                                   \
                $$ t = st.top(); st.pop();                      \
                int q = min(k, t.second);                       \
                t.second -= q;                                  \
                if (t.second) st.push(t);                       \
                res -= f(cur.pos - t.first) * q;                \
                k -= q;                                         \
            }                                                   \
        }                                                       \
    });                                                         \
