...
void process()
{
    ...
    while (check())
    {
        ...
        else if (alphacnt['W' - 'A'])
        {
            rem(names[2]);
            ans.push_back(2);
        }
        else if (alphacnt['U' - 'A'])
        {
            rem(names[4]);
            ans.push_back(4);
        }
        else if (alphacnt['X' - 'A'])
        {
            rem(names[6]);
            ans.push_back(6);
        }
        else if (alphacnt['G' - 'A'])
        {
            rem(names[8]);
            ans.push_back(8);
        }
        else if (alphacnt['O' - 'A'])
        {
            rem(names[1]);
            ans.push_back(1);
        }
        else if (alphacnt['R' - 'A'])
        {
            rem(names[3]);
            ans.push_back(3);
        }
        else if (alphacnt['S' - 'A'])
        {
            rem(names[7]);
            ans.push_back(7);
        }
        else if (alphacnt['F' - 'A'])
        {
            rem(names[5]);
            ans.push_back(5);
        }
