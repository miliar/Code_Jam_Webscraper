...
//#else
#define macroScope(i,v) if(bool i##Scope = true) for(typename MoveReference<decltype((v))>::type i = v; i##Scope; i##Scope = false)
//#endif
...
#define fori(i,n) for(std::remove_const_t<std::remove_reference_t<decltype((n))>> i = 0, i##End = n; i < i##End; ++i)
#define fori2(i,s,n) for(std::remove_const_t<std::remove_reference_t<decltype((n))>> i = s, i##End = n; i < i##End; ++i)
