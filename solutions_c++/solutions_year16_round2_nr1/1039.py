...
int main(void){
    ...
    for(long T=0;T<test_cases;T++){
        ...
        for(long i=0;i<s1.size();i++)
            lCount[s1[i]-'A']++;
        //0
        digitCount[0]=lCount[25];
        lCount['E'-'A']-=lCount[25];
        lCount['R'-'A']-=lCount[25];
        lCount['O'-'A']-=lCount[25];
        lCount[25]=0;
        //2
        digitCount[2]=lCount['W'-'A'];
        lCount['T'-'A']-=digitCount[2];
        lCount['O'-'A']-=digitCount[2];
        lCount['W'-'A']=0;
        //6
        digitCount[6]=lCount['X'-'A'];
        lCount['S'-'A']-=digitCount[6];
        lCount['I'-'A']-=digitCount[6];
        lCount['X'-'A']=0;
        //7
         digitCount[7]=lCount['S'-'A'];
        lCount['E'-'A']-=2*digitCount[7];
        lCount['V'-'A']-=digitCount[7];
        lCount['N'-'A']-=digitCount[7];
        lCount['S'-'A']=0;
        //5
        digitCount[5]=lCount['V'-'A'];
        lCount['F'-'A']-=digitCount[5];
        lCount['I'-'A']-=digitCount[5];
        lCount['E'-'A']-=digitCount[5];
        lCount['V'-'A']=0;
        //026754//1389
        digitCount[4]=lCount['F'-'A'];
        lCount['O'-'A']-=digitCount[4];
        lCount['U'-'A']-=digitCount[4];
        lCount['R'-'A']-=digitCount[4];
        lCount['F'-'A']=0;
        //1
        digitCount[1]=lCount['O'-'A'];
        lCount['N'-'A']-=digitCount[1];
        lCount['E'-'A']-=digitCount[1];
        lCount['O'-'A']=0;
        //3
        digitCount[3]=lCount['R'-'A'];
        lCount['T'-'A']-=digitCount[3];
        lCount['H'-'A']-=digitCount[3];
        lCount['E'-'A']-=2*digitCount[3];
        lCount['R'-'A']=0;
        digitCount[8]=lCount['T'-'A'];
        lCount['E'-'A']-=digitCount[8];
        lCount['I'-'A']-=digitCount[8];
        lCount['G'-'A']-=digitCount[8];
        lCount['H'-'A']-=digitCount[8];
        digitCount[9]=lCount['I'-'A'];
        cout<<"Case #"<<T+1<<": ";
        for(long i=0;i<10;i++){
            for(long j=0;j<digitCount[i];j++)
                cout<<i;
        }
        cout<<endl;
        //cout<<ans<<endl;
