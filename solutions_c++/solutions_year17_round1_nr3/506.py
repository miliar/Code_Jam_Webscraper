    ...
    int solve()
    {
        ...
        while (! Q.empty() ) {
            ...
            for (char option: options) {
                ...
                if (option == 'A') {
                    //attack
                    n_hk = std::max(0, n_hk - ad);
                } else if (option == 'B') {
                    n_ad = std::min(ad + B, hk);
                } else if (option == 'D') {
                    n_ak = std::max(ak - D, 0);
                } else { //C
                    n_hd = Hd;
                ...
                if (n_hk == 0) {
                    ...
                    n_hd = std::max(0, n_hd - n_ak);
                    if (n_hd > 0) {
                        // life goes on
                        int nd = d + 1;
                        if ( dist[n_hd][n_ad][n_hk][n_ak] > d + 1) {
                            dist[n_hd][n_ad][n_hk][n_ak] = d + 1;
                            Q.push( n_hd );
                            Q.push( n_ad );
                            Q.push( n_hk );
                            Q.push( n_ak );
