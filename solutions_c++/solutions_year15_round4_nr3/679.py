...
int A[2503], B[2503], C[2503], pos[2503];
    ...
    while(ts--) {
        ...
        rep(b, 0, (1<<n) - 1) {
            ...
            rep(i, 0, n - 1) {
                ...
                repv(j, vv[i]) {
                    int val = d[pos[vv[i][j]]];
                    if(val != 3) {
                        if(tp == 1) {
                            if(val == 2) d[pos[vv[i][j]]] = 3;
                            else if(val != 1) d[pos[vv[i][j]]] = 1;
                        } else {
                            if(val == 1) d[pos[vv[i][j]]] = 3;
                            else if(val != 2) d[pos[vv[i][j]]] = 2;
                        }
                    }
                }
            }
