...
void sfileIO(){freopen("D-small-attempt0.in","r",stdin); freopen("D-small.out","w",stdout);}
void lfileIO(){freopen("D-large.in","r",stdin); freopen("D-large.out","w",stdout);}
...
int main(int argc, char** argv)
{
    ...
    for(int testcase=1;testcase<=testcases;testcase++){
        ...
        cout<<"Case #"<<testcase<<": "<<pp<<" "<<n-qq<<endl;
    }
