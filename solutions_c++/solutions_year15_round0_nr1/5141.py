...
int main()
{
    ...
    vector<string> vec;
    ifstream fichier("C:/Users/Firas/Documents/code jam/A-small-practice.in", ios::in);  // on ouvre le fichier en lecture
    int Ncases = 0;
        ...
        ofstream fichier1("C:/Users/Firas/Documents/code jam/", ios::out | ios::trunc);  // ouverture en écriture avec effacement du fichier ouvert
