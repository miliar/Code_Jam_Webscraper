...
# X=1 case - GABRIEL (always possible)
# X=2 case - possible if RxC is even
# X=3 case - not possible if R and C < 3
#            always possible in 2x3, 3x3 and 3x4; not possible in 4x4, 4x1, 4x2
# X=4 case - not possible if R and C < 4
#            4x4 - possible
#            4x3 - possible
#            4x2 - not possible
#            4x1 - not possible
    if x == 1: return 'GABRIEL'
    if x == 2: return 'GABRIEL' if (((r*c) & 1) == 0) else 'RICHARD'
    if x == 3: return 'GABRIEL' if (r*c in [6, 9, 12]) else 'RICHARD'
    if x == 4: return 'GABRIEL' if (r*c in [16, 12]) else 'RICHARD'
