...
i × N. For example, suppose that Bleatrix picks N = 1692. She would count as
follows:
...
have appeared for the first time in the numbers 10, 10, 2, 30, 4, 50, 6, 70,
and 8, respectively.
...
def test_counting_sheep():
    '''Provide some test cases for this problem'''
