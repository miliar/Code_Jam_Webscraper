...
def process(fp):
    first_answer = int(fp.readline().rstrip())
    # print 'First answer:', first_answer
    for row_num in range(4):
        row = fp.readline().rstrip().split()
        if row_num == first_answer -1:
            first_row = row
    second_answer = int(fp.readline().rstrip())
    # print 'Second answer:', second_answer
    results = 0
    for row_num in range(4):
        row = fp.readline().rstrip().split()

        if row_num == second_answer -1:
            for num in row:
                if num in first_row:
                    results = results+1
                    answer = num
