...
# def expand_list(num_list):
# 	return flatten(map(expand, num_list))
...
# 	num_list = [bathroom]
# 	for i in range(bin_case):
# 		num_list = expand_list(num_list)

# 	slot = guy - 2**(bin_case-1)

# 	return "{0} {1}".format(num_list[slot*2], num_list[slot*2 +1])
