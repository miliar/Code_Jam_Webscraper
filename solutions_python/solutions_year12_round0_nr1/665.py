...
trans =  maketrans(
    "qaozejp mysljylc kd kxveddknmc re jsicpdrysirbcpc ypc rtcsra dkh wyfrepkym veddknkmkrkcdde kr kd eoya kw aej tysr re ujdr lkgc jv",
    "zyeqour language is impossible to understandthere are twenty six factorial possibilitiesso it is okay if you want to just give up")


st ="""ejp mysljylc kd kxveddknmc re jsicpdrysi
...
ls = st.translate(trans).split("\n")

for i in range(0,len(ls)):
    print "Case #{0}: {1}".format(i+1, ls[i])
