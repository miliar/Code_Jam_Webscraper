g = open('D:\Users\john\My Documents\Google Code Jam\Google Code Jam 2015\ovation_small_out.txt','w+')

with open('D:\Users\john\My Documents\Google Code Jam\Google Code Jam 2015\ovation_small.txt', 'r+') as f:
