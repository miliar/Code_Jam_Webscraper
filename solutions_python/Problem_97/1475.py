...
def challengeC():
    output = ''
    #read file
    fileString = open('/Users/Lenny/Desktop/CodeJam-2012/C-small.in', 'r').read()
    ...
    for line in fileArray:
        ...
        caseNumb += 1
    outputFile = open('/Users/Lenny/Desktop/CodeJam-2012/C-small.out', 'w')
