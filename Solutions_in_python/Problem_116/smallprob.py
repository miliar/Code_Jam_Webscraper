        ...
        # Split each character
            ...
            for str in position:
                ...
                if firstrow=='X' or firstrow=='O':
                    ...
                    if numOccur==4:
                        print "Case #",countgame,":" ,firstrow,"won"
                        gameover=True
                        break
                    elif numOccur==3:
                        if str.count('T')==1:
                    ...
                    if str.count("X")==3:
                        print "Case #",countgame,": X won"
                        gameover=True
                        break
                    elif str.count("O")==3:
                        print "Case #",countgame,": O won"
                        gameover=True
                        break
            if not gameover: 
                for str in position:
...
# Check column now
                ...
                for str in column:
                    ...
                    if firstcol=='X' or firstcol=='O':
                        ...
                        if numOccur==4:
                            print "Case #",countgame,":" ,firstcol,"won"
                            gameover=True
                            break
                        elif numOccur==3:
                            if str.count('T')==1:
...
# Check diagonal
                ...
                for str in diagonal:
                    ...
                    if firstdia=='X' or firstdia=='O':
                        ...
                        if numOccur==4:
                            print "Case #",countgame,":" ,firstdia,"won"
                            gameover=True
                            break
                        elif numOccur==3:
                            if str.count('T')==1:
            ...
            if not gameover:
                if numberempty==0:
                    print "Case #",countgame,": Draw"
                else:
                    print "Case #",countgame,": Game has not completed"
            gameover=True
            infile.readline()
            countgame+=1
